...
import BinaryTree.Hard.BinaryTreeMaximumPathSum.TreeNode;
...
public class VerticalOrderTraversalofaBinaryTree {
    ...
    class Solution {
        ...
        public List<List<Integer>> verticalTraversal(TreeNode root) {
            ...
            // We need a treemap to store the vertical values(columns) and PriorityQueue to
            // store the node values in increasing order.
            // (x,y,node)
            TreeMap<Integer, TreeMap<Integer, PriorityQueue<Integer>>> map = new TreeMap<>();

            // Create a queue for instering each node with respective row(x), column(y)
